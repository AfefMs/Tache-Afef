 ...
 */
final class Version20241218154354 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE cours (id INT AUTO_INCREMENT NOT NULL, nom_c VARCHAR(250) NOT NULL, duree_c INT NOT NULL, periode_c INT NOT NULL, description_c VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE ressource (id INT AUTO_INCREMENT NOT NULL, cours_id INT NOT NULL, type_r VARCHAR(255) NOT NULL, nom_r VARCHAR(255) NOT NULL, file_r VARCHAR(255) NOT NULL, duree_r VARCHAR(255) DEFAULT NULL, pdfressource VARCHAR(255) DEFAULT NULL, INDEX IDX_939F45447ECF78B0 (cours_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
